...
function walk!(G:: DefaultDict, pcontig:: Vector{DNASeq}, freq, offset_in_prefix :: Int64 , mn :: macro_node, pid :: Int64, output :: Set)
    ...
    for (id,offset_in_suffix,count) in mn.wire_info[pid]
       # print("id, ",id, "  pid, ",pid,"  offset_in_suffix ",offset_in_suffix, "  offset_inprefix ", offset_in_prefix,"  count",count,"\n")
        ...
        print("pref",DNASeq_to_string(pcontig[end]),"   suff",DNASeq_to_string(mn.suffixes[id][1]),"\n")
